  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        line: "hsl(var(--line))", "brand-soft": "hsl(var(--brand-soft))", "neutral-vote": "hsl(var(--neutral-vote))",
      ...
      keyframes: {
        ...
        "signal-sweep": { "0%": { transform: "translateX(-60%)" }, "100%": { transform: "translateX(160%)" } },
        "slow-float": { "0%, 100%": { transform: "translateY(0)" }, "50%": { transform: "translateY(-10px)" } },
      },
      animation: { "accordion-down": "accordion-down 0.2s ease-out", "accordion-up": "accordion-up 0.2s ease-out", "rise-in": "rise-in 0.5s ease-out both", "signal-sweep": "signal-sweep 3s ease-in-out infinite", "slow-float": "slow-float 7s ease-in-out infinite" },
    },
  },
