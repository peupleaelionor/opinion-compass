...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: { "hero": "var(--gradient-hero)", "brand": "var(--gradient-brand)" },
      ...
      animation: { "accordion-down": "accordion-down 0.2s ease-out", "accordion-up": "accordion-up 0.2s ease-out", "rise-in": "rise-in 0.5s ease-out both", "signal-sweep": "signal-sweep 3s ease-in-out infinite" },
    },
  },
